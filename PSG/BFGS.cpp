...
void BFGS::LineSearch(T &totalEnergy, const int doubleO[2][2])
{
	...
	while (num < 300) 
	{
		...
		T firstItem[193 * 3 * 193 * 3];//define firstItem in 2D dimension
		...
		T secondItem1[193 * 3 * 193 * 3];//define secondItem1 in 2D dimension
		m = 193 * 3, n = 193 * 3, k = 1;
		a = 1, b = 0;
		cblas_dgemm(CblasRowMajor, CblasNoTrans, CblasNoTrans,
		...
		T secondItem2[193 * 3 * 193 * 3];//define secondItem2 in 2D dimension
		m = 193 * 3, n = 1, k = 193 * 3;
		a = 1, b = 0;
		cblas_dgemm(CblasRowMajor, CblasNoTrans, CblasNoTrans,
		...
		T secondItem[193 * 3 * 193 * 3];//define secondItem in 2D dimension
